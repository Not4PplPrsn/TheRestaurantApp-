...
{id: 1, dishName: 'Tiramisu', description: 'Espresso-soaked ladyfingers layered with mascarpone cream.  Finished with a dusting of cocoa. Rich, velvety, and perfectly balanced.', courseName: 'Dessert', price: 1500, image: tiramisuImage},
{id: 2, dishName: 'Sacher Torte', description: 'Dense chocolate sponge layered with apricot jam is sealed beneath a glossy dark chocolate glaze.Subtle fruit brightness and deep cocoa richness deliver an elegant finish in every bite.', courseName: 'Dessert', price: 1700, image:sacherTorteImage },
...
{id: 6, dishName: 'Chicken Tagliatelle', description: 'This is an alcohol', courseName: 'Entree', price: 1000, image: chickenTagliatelle},
...
{id: 9, dishName: 'Stove Top Lamb', description: "Tender lamb seared and slow cooked on the stove top with aromatic herbs and root vegetables. Finished with a rich reduction of stock and wine, this dish delivers deep flavor and comforting warmth in every bite. A rustic yet refined option for hearty appetites.", courseName: 'Main', price: 1000, image: stoveLamb},
