...
const splitPeaSoup = require('../assets/images/Dishes/Mains/WoolWorthDish.webp');
...
{id: 1, dishName: 'Tiramisu', description: 'Espresso-soaked ladyfingers layered with mascarpone cream.  Finished with a dusting of cocoa. Rich, velvety, and perfectly balanced.', courseName: 'Dessert', price: 1500, image: tiramisuImage, isDeleted: false},
{id: 2, dishName: 'Sacher Torte', description: 'Dense chocolate sponge layered with apricot jam is sealed beneath a glossy dark chocolate glaze.Subtle fruit brightness and deep cocoa richness deliver an elegant finish in every bite.', courseName: 'Dessert', price: 1700, image:sacherTorteImage, isDeleted: false },
...
{id: 5, dishName: 'Chicken Tagliatelle', description: 'Chicken tagliatelle is a comforting Italian pasta dish featuring tender strips of chicken tossed with silky ribbons of tagliatelle. Coated in a creamy garlic sauce with hints of parmesan and herbs, it balances richness and freshness. Perfectly hearty yet elegant, it’s a satisfying meal for any occasion.', courseName: 'Entrée', price: 1000, image: chickenTagliatelle, isDeleted: false},
{id: 6,dishName: 'Wreath Bread', description: 'Artisan bread shaped into a golden wreath, baked to a crisp crust with a soft airy center. Infused with rosemary and sea salt, this centerpiece loaf brings warmth and elegance to any table. Ideal for sharing, dipping, or pairing with cheese and wine.', courseName: 'Entrée', price: 1000, image: wreathBread, isDeleted: false},
{id: 7, dishName: 'Queen Scallops', description: "Delicate queen scallops lightly seared and served with a citrus herb butter. Their natural sweetness is balanced by a touch of sea salt and lemon zest, offering a clean elegant flavor. Perfect as a starter or paired with seasonal greens for a refined main.", courseName: 'Entrée', price: 1000, image: queenScallops, isDeleted: false},
{id: 8, dishName: 'Split peas soup ', description: 'Velvety split pea soup slow simmered with garden vegetables and aromatic herbs. Crafted by a five star kitchen, this dish balances earthy depth with refined texture. Finished with a drizzle of cold pressed olive oil and a touch of microgreens for a clean, elegant presentation.', courseName: 'Main', price: 1000, image: splitPeaSoup, isDeleted: false },
{id: 9, dishName: 'Stove Top Lamb', description: "Tender lamb seared and slow cooked on the stove top with aromatic herbs and root vegetables. Finished with a rich reduction of stock and wine, this dish delivers deep flavor and comforting warmth in every bite. A rustic yet refined option for hearty appetites.", courseName: 'Main', price: 1000, image: stoveLamb, isDeleted: false},
{id: 10, dishName: 'Sunday Roast', description: "A refined take on the classic Sunday roast, crafted by The Savoy's five star kitchen. Featuring seasonal vegetables, slow roasted meats or elegant plant based mains, each plate is balanced with light sauces and modern garnishes. Designed for comfort and sophistication, this dish reimagines tradition with flair.", courseName: 'Main', price: 1000, image: altSundayRoast, isDeleted: false},
{id: 11, dishName: 'Pheasant with Mustard and White whine  sauce', description: 'Tender wild pheasant pan roasted and served with a creamy mustard and white wine sauce. Balanced with hints of garlic and thyme, the sauce enhances the rich flavor of the game bird. Accompanied by seasonal vegetables and rustic potatoes for a hearty, elegant dish', courseName: 'Entrée', price: 1000, image: Pheasant, isDeleted: false},
{id: 12, dishName: 'Wild Chicken', description: 'Succulent free range wild chicken slow roasted to golden perfection, infused with a delicate blend of herbs and a splash of crisp white wine. Each bite reveals tender juicy meat with subtle notes of garlic, rosemary, and citrus, balanced by the wines gentle acidity. The skin is irresistibly crispy, locking in rich aromatic flavors. Served with pan roasted seasonal vegetables and a drizzle of white wine reduction, this dish is a rustic yet refined celebration of natural ingredients and timeless technique.', courseName: 'Main', price: 1000, image:wildChicken, isDeleted: false},
]
