...
{id: 9, dishName: 'Stove Top Lamb', description: "Tender lamb seared and slow cooked on the stove top with aromatic herbs and root vegetables. Finished with a rich reduction of stock and wine, this dish delivers deep flavor and comforting warmth in every bite. A rustic yet refined option for hearty appetites.", courseName: 'Main', price: 800, image: stoveLamb, isDeleted: false},
{id: 10, dishName: 'Sunday Roast', description: "A refined take on the classic Sunday roast, crafted by The Savoy's five star kitchen. Featuring seasonal vegetables, slow roasted meats or elegant plant based mains, each plate is balanced with light sauces and modern garnishes. Designed for comfort and sophistication, this dish reimagines tradition with flair.", courseName: 'Main', price: 8000, image: altSundayRoast, isDeleted: false},
{id: 11, dishName: 'Pheasant with Mustard and White whine  sauce', description: 'Tender wild pheasant pan roasted and served with a creamy mustard and white wine sauce. Balanced with hints of garlic and thyme, the sauce enhances the rich flavor of the game bird. Accompanied by seasonal vegetables and rustic potatoes for a hearty, elegant dish', courseName: 'Entrée', price: 900, image: Pheasant, isDeleted: false},
