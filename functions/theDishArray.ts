...
{id: 10, dishName: 'Sunday Roast', description: "A refined take on the classic Sunday roast, crafted by The Savoy's five star kitchen. Featuring seasonal vegetables, slow roasted meats or elegant plant based mains, each plate is balanced with light sauces and modern garnishes. Designed for comfort and sophistication, this dish reimagines tradition with flair.", courseName: 'Main', price: 800, image: altSundayRoast, isDeleted: false},
