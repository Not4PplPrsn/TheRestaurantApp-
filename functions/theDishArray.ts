...
{id: 6, dishName: 'Chicken Tagliatelle', description: 'This is an alcohol', courseName: 'Entree', price: 1000, image: chickenTagliatelle, isDeleted: false},
...
{id: 7, dishName: 'Queen Scallops', description: "Delicate queen scallops lightly seared and served with a citrus herb butter. Their natural sweetness is balanced by a touch of sea salt and lemon zest, offering a clean elegant flavor. Perfect as a starter or paired with seasonal greens for a refined main.", courseName: 'Entree', price: 1000, image: queenScallops, isDeleted: false},
...
{id: 11, dishName: 'Pheasant with Mustard and White whine  sauce', description: 'Tender wild pheasant pan roasted and served with a creamy mustard and white wine sauce. Balanced with hints of garlic and thyme, the sauce enhances the rich flavor of the game bird. Accompanied by seasonal vegetables and rustic potatoes for a hearty, elegant dish', courseName: 'Entree', price: 1000, image: Pheasant, isDeleted: false},
